...
{
    public class FadeInOutController : MonoBehaviour, IFadeInOutController
    {
        [SerializeField] FadeID identifier;
        ...
        public FadeID Identifier => identifier;

        private void Awake()
        {
            canvasGroup = GetComponent<CanvasGroup>();
            InterfaceDependencyInjector.Instance.Register<IFadeInOutController>(() => this, identifier);
        }
